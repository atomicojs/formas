        ...
        <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
            <g clip-path="url(#clip0_615_263)">
                <rect
                    ...
                    fill="black"
                />
                <rect x="7" y="5" width="2" height="2" rx="1" fill="black" />
                <rect x="10" y="5" width="2" height="2" rx="1" fill="black" />
                <rect x="4" y="8" width="2" height="2" rx="1" fill="black" />
                <rect x="7" y="8" width="2" height="2" rx="1" fill="black" />
                <rect x="10" y="8" width="2" height="2" rx="1" fill="black" />
                <rect x="4" y="11" width="2" height="2" rx="1" fill="black" />
