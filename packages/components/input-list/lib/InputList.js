...
import { u as useCurrentValue, a as useListener, b as useRefValues, c as addListener, d as useSlot, P as PrimitiveTokens, A as ActionTokens, B as ButtonTokens, C as CardTokens, S as Sizes, e as ColorsBackground, f as ShadowDeep, I as Icon } from './chunks/0437656d98e858ea8604835a9dc210d1.js';
import { useHost, useState, Mark, useRef, useLayoutEffect, useEffect, useUpdate, options, usePromise, c, css, useProp, createContext, createRef, useContext, useEvent } from 'atomico';
import { u as useMutationObserver, a as useDisabled, b as useReflectEvent, c as useRender, I as InputGenericProps, d as useParent } from './chunks/f9f495a3d53951c0dbc5bef64a261836.js';
 ...
 */
const listener = (handler) => addListener(window, "popstate", handler);
...
const cache$1 = {};
const getMatch = (path) => (cache$1[path] = cache$1[path] || createMatch(path));
const matches = (routes, currentPath) => {
...
function useRoute(path, callback = (param) => param) {
 ...
 */
function useRedirect(ref, { proxy, composed = true, } = {}) {
    useListener(ref, "click", (event) => {
        const { current } = ref;
